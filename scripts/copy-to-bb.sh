...
rave_print "Copy files to public Bulletin Board"
...
mkdir -p ${BULLETIN_BOARD}/vf/mix2
cp ${VF_WORKSPACE}/Party01/nizkp/mix1/ShuffledCiphertexts.bt ${BULLETIN_BOARD}/vf/mix2/Ciphertexts.bt
cp ${VF_WORKSPACE}/Party01/nizkp/mix2/ShuffledCiphertexts.bt ${BULLETIN_BOARD}/vf/mix2/
cp ${VF_WORKSPACE}/Party01/nizkp/mix2/FullPublicKey.bt ${BULLETIN_BOARD}/vf/mix2/
mkdir -p ${BULLETIN_BOARD}/vf/mix2/proofs
cp ${VF_WORKSPACE}/Party01/nizkp/mix2/proofs/PoSReply01.bt ${BULLETIN_BOARD}/vf/mix2/proofs/
cp ${VF_WORKSPACE}/Party01/nizkp/mix2/proofs/PoSCommitment01.bt ${BULLETIN_BOARD}/vf/mix2/proofs/
cp ${VF_WORKSPACE}/Party01/nizkp/mix2/proofs/PermutationCommitment01.bt ${BULLETIN_BOARD}/vf/mix2/proofs/
